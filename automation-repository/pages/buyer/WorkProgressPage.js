...
/**
 * WorkProgressPage.js — Scaffolded Page Object Model for buyer / work-progress.
 *
 * AUTO-GENERATED by scripts/scaffold-poms.js — extend with business methods.
 * Selectors sourced from locators/buyer/locator-map.json (module key: "work-progress").
 *
...
class WorkProgressPage extends BasePage {
  constructor(page) {
    ...
    this.rcTabs1Tab1                    = page.locator(L['rcTabs1Tab1'] && L['rcTabs1Tab1'].selector);
    this.rcTabs1Tab2                    = page.locator(L['rcTabs1Tab2'] && L['rcTabs1Tab2'].selector);
...
module.exports = { WorkProgressPage };
