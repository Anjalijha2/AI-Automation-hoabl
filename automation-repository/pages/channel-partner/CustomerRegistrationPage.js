...
/**
 * CustomerRegistrationPage.js — Scaffolded Page Object Model for channel-partner / customer-registration.
 *
...
class CustomerRegistrationPage extends BasePage {
  constructor(page) {
    ...
    this.r2Input                        = page.locator(L['r2Input'] && L['r2Input'].selector);
    this.r2Input2                       = page.locator(L['r2Input2'] && L['r2Input2'].selector);
