...
8. ~~Q-ALLOC-001~~ — ✅ RESOLVED (test environment exists)
...
12. ~~Q-CMS-002~~ — ✅ RESOLVED (project-level, max registrations per unit)
13. ~~Q-CMS-006~~ — ✅ RESOLVED
14. ~~Q-SM-001~~ — ✅ RESOLVED (email not enforced unique)
15. ~~Q-SM-002~~ — ✅ RESOLVED (auto-save per toggle)

**Previously LOW (now resolved):**
16. ~~Q-OFFERS-001~~ — ✅ RESOLVED (no search/filter)
17. ~~Q-SM-003~~ — ✅ RESOLVED (Sales Manager + Sales Manager Admin)
18. ~~Q-SM-004~~ — ✅ RESOLVED (same table, different roleId, cannot overlap)
19. ~~Q-SM-005~~ — ✅ RESOLVED (no audit logging)
20. ~~Q-CMS-007~~ — ✅ RESOLVED
21. ~~Q-CMS-008~~ — ✅ RESOLVED
22. ~~Q-CMS-009~~ — ✅ RESOLVED (existing preferences NOT invalidated)
23. ~~Q-CMS-010~~ — ✅ RESOLVED (XLSX download with per-row errors)
24. ~~Q-CP-001~~ — ✅ RESOLVED (auto-populated via smUserId JOIN)
25. ~~Q-CP-002~~ — ✅ RESOLVED (feature fully implemented)
26. ~~Q-JBP-001~~ — ✅ Partially resolved (tab names confirmed)
27. ~~Q-JBP-002~~ — ✅ RESOLVED (edit-request approval workflow)
28. ~~Q-TXN-002~~ — ✅ RESOLVED (dynamic from payment_transaction_types table)
29. ~~Q-TXN-003~~ — ✅ RESOLVED (SM portal OfflinePaymentDrawer)
30. ~~Q-TXN-006~~ — ✅ RESOLVED (10, 20, 50, 100)
31. ~~Q-TXN-007~~ — ✅ RESOLVED (deferred, both controller and service have TODO comments)
32. ~~Q-ALLOC-002~~ — ✅ RESOLVED (cannot set BOOKED directly; requires full allocation flow)
