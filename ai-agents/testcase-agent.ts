 ...
 *
 * Run:
 *   npx ts-node agents/agent2-testcase-gen.ts
 * ============================================================
 */
...
const LOGIN_TEST_CASES: TestCase[] = [
  // ── Positive ────────────────────────────────────────────────────────────────
  {
...
const CUSTOMERS_TEST_CASES: TestCase[] = [
  {
...
function formatTestCases(moduleName: string, cases: TestCase[]): string {
...
function run() {
  ...
  const testModules: [string, TestCase[]][] = [
