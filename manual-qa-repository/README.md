...
```
manual-qa-repository/
├── 01-test-cases/          ← Manual TCs per module (agent-generated + hand-written)
├── 02-testing-types/       ← Smoke, regression, sanity, UAT sign-off, retesting, exploratory
├── 03-user-manual/         ← Admin guide + per-screen documentation (12 dimensions)
...
2. Manual Test Cases       → 01-test-cases/<module>/TC_<MODULE>.md  (BA sign-off required)
...
| Check smoke checklist | [02-testing-types/smoke/SMOKE_CHECKLIST.md](02-testing-types/smoke/SMOKE_CHECKLIST.md) |
