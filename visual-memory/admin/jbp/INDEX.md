...
|------|--------|--------------|
| `screenshot-desktop.png` | JBP Management — desktop view (1920×900) | stub — captured before INDEX.md existed |
| `screenshot-ui.png` | JBP Management — UI baseline | stub — captured before INDEX.md existed |
