...
|------|--------|--------------|
| `screenshot-desktop.png` | Channel Partners — desktop view (1920×900) | stub — captured before INDEX.md existed |
| `screenshot-ui.png` | Channel Partners — UI baseline | stub — captured before INDEX.md existed |
