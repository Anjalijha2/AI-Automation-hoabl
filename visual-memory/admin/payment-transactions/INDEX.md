...
|------|--------|--------------|
| `screenshot-desktop.png` | Payment Transactions — desktop view (1920×900) | stub — captured before INDEX.md existed |
| `screenshot-ui.png` | Payment Transactions — UI baseline | stub — captured before INDEX.md existed |
