# Visual Memory — Channel Partner Portal / Leads Management
...
|------|--------|--------------|
| `screenshot-desktop.png` | Leads Management — desktop view (1920×900) | stub — captured before INDEX.md existed |
