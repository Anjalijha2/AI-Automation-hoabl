# Visual Memory — Channel Partner Portal / Customer Registration
...
|------|--------|--------------|
| `screenshot-desktop.png` | Customer Registration — desktop view (1920×900) | stub — captured before INDEX.md existed |
